    ...
    return (
        <div>
            ...
            <div>
              ...
              <br />
              <p>My goal with this website is to create a community for turbo miata enthusiasts that want to post with questions or talk about what it is the users are working on.</p><br /><br /><br />
            </div>
        </div>
    )
}
